                                                ...
                                                <div className="col-sm-12">
                                                    ...
                                                    >
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr className="even">
                                                                <td className="sorting_1">{post.Product_Name} </td>
                                                                <td>-</td>
                                                                <td>{post.Product_Category}</td>
                                                                <td>{post.Applicable_Standards}</td>
                                                                <td>date</td>
                                                                {/* <td><Button size="small" color="secondary" onClick={view}> <VisibilityIcon fontSize="small" /> </Button></td>
                                                                <td><Button size="small" color="secondary" onClick={update}> <EditIcon fontSize="small" /> </Button></td>
                                                                <td><Button size="small" color="secondary" onClick={() => dispatch(deleteProducts(post._id))}> <DeleteIcon fontSize="small" /> Delete </Button></td>
 */}
