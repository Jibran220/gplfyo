                    ...
                    <div>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Household} onChange={(e) => setPostData({ ...postData, Household: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Household </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Commercial} onChange={(e) => setPostData({ ...postData, Commercial: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Commercial </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Clinical} onChange={(e) => setPostData({ ...postData, Clinical: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Clinical </label>
                            </div>
                        </div>
                        <div className="col-md-4">
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="customRadio" className="custom-control-input" value='Yes' onChange={(e) => setPostData({ ...postData, TradeMark: e.target.value })} />
                                <label className="custom-control-label" for="customRadio1">Yes </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="customRadio" className="custom-control-input" value='No' onChange={(e) => setPostData({ ...postData, TradeMark: e.target.value })} />
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="customRadio" className="custom-control-input" value='Continous' onChange={(e) => setPostData({ ...postData, Operation_Mode: e.target.value })} />
                                <label className="custom-control-label" for="customRadio1">Continous </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="customRadio" className="custom-control-input" value=' Duty Cycle' onChange={(e) => setPostData({ ...postData, Operation_Mode: e.target.value })} />
                                <label className="custom-control-label" for="customRadio2"> Duty Cycle </label>
                            </div>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.Ordinary_person} onChange={(e) => setPostData({ ...postData, Ordinary_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Ordinary person </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Children_likely_present} onChange={(e) => setPostData({ ...postData, Children_likely_present: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Children likely present </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Instructed_person} onChange={(e) => setPostData({ ...postData, Instructed_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Instructed person </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Skilled_person} onChange={(e) => setPostData({ ...postData, Skilled_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Skilled person  </label>
                            </div>
                        </div>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.AC_mains} onChange={(e) => setPostData({ ...postData, AC_mains: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">AC mains </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.DC_mains} onChange={(e) => setPostData({ ...postData, DC_mains: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> DC mains </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Battery_Powered} onChange={(e) => setPostData({ ...postData, Battery_Powered: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Battery Powered </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Skilled_person} onChange={(e) => setPostData({ ...postData, Skilled_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Skilled person  </label>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.Skilled_person} onChange={(e) => setPostData({ ...postData, Skilled_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Non-detachable Supply Cord </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Skilled_person} onChange={(e) => setPostData({ ...postData, Skilled_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Appliance Coupler </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Skilled_person} onChange={(e) => setPostData({ ...postData, Skilled_person: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2"> Direct plug-in </label>
                            </div>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.Non_detachable_Supply_Cord_B} onChange={(e) => setPostData({ ...postData, Non_detachable_Supply_Cord_B: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Non-detachable Supply Cord B </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Appliance_Coupler_B} onChange={(e) => setPostData({ ...postData, Appliance_Coupler_B: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Appliance Coupler B </label>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.Permanent_connection} onChange={(e) => setPostData({ ...postData, Permanent_connection: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Permanent connection
                                </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Mating_connector} onChange={(e) => setPostData({ ...postData, Mating_connector: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Mating connector
                                </label>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.Movable} onChange={(e) => setPostData({ ...postData, Movable: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Movable
                                </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Transportable} onChange={(e) => setPostData({ ...postData, Transportable: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Transportable
                                </label>

                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Stationary_for_building_in} onChange={(e) => setPostData({ ...postData, Stationary_for_building_in: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Stationary for building-in
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Wall_ceiling_mounted_SRME_rack_mounted} onChange={(e) => setPostData({ ...postData, Wall_ceiling_mounted_SRME_rack_mounted: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Wall/ceiling-mounted SRME/rack-mounted

                                </label>

                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Hand_held} onChange={(e) => setPostData({ ...postData, Hand_held: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Hand-held

                                </label>

                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Other} onChange={(e) => setPostData({ ...postData, Other: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Other
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="customRadio" className="custom-control-input" value='P1' onChange={(e) => setPostData({ ...postData, Pollution_Degree: e.target.value })} />
                                <label className="custom-control-label" for="customRadio1">P1 </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="customRadio" className="custom-control-input" value=' P2' onChange={(e) => setPostData({ ...postData, Pollution_Degree: e.target.value })} />
                                <label className="custom-control-label" for="customRadio2"> P2  </label>
                            </div>  <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="customRadio" className="custom-control-input" value=' P3' onChange={(e) => setPostData({ ...postData, Pollution_Degree: e.target.value })} />
                                <label className="custom-control-label" for="customRadio2"> P3  </label>
                            </div>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio1" name="customRadio" className="custom-control-input" checked={postData.Indoor} onChange={(e) => setPostData({ ...postData, Indoor: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio1">Indoor

                                </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="checkbox" id="customRadio2" name="customRadio" className="custom-control-input" checked={postData.Outdoor} onChange={(e) => setPostData({ ...postData, Outdoor: e.target.checked })} />
                                <label className="custom-control-label" for="customRadio2">Outdoor
                                </label>
                        ...
                        <div className="col-md-3">
                            ...
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio1" name="customRadio" className="custom-control-input" value='Replaceable' onChange={(e) => setPostData({ ...postData, Fuse_Type: e.target.value })} />
                                <label className="custom-control-label" for="customRadio1">Replaceable </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="customRadio" className="custom-control-input" value=' Non-Replaceable' onChange={(e) => setPostData({ ...postData, Fuse_Type: e.target.value })} />
                                <label className="custom-control-label" for="customRadio2"> Non-Replaceable
                                </label>
                            </div>
                            <div className="custom-control custom-radio">
                                <input type="radio" id="customRadio2" name="customRadio" className="custom-control-input" value='None' onChange={(e) => setPostData({ ...postData, Fuse_Type: e.target.value })} />
                                <label className="custom-control-label" for="customRadio2"> None
                                </label>
                            </div>
